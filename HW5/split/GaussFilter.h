...
public:
	...
	sc_in < bool >  i_rst;
#ifndef NATIVE_SYSTEMC
	cynw_p2p< sc_dt::sc_uint<8> >::in input_r;
	cynw_p2p< sc_dt::sc_uint<8> >::in input_g;
	cynw_p2p< sc_dt::sc_uint<8> >::in input_b;
	cynw_p2p< sc_dt::sc_uint<8> >::out o_result_r;
	cynw_p2p< sc_dt::sc_uint<8> >::out o_result_g;
	cynw_p2p< sc_dt::sc_uint<8> >::out o_result_b;
#else
	sc_fifo_in< sc_dt::sc_uint<8> >::in input_r;
	sc_fifo_in< sc_dt::sc_uint<8> >::in input_g;
	sc_fifo_in< sc_dt::sc_uint<8> >::in input_b;
